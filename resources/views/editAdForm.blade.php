            ...
            <div class="row">
                ...
                <div class="col-md-8 offset-3">
                 ...
                 <form action="{{ route('home.saveEditedAd', ['id' => $ad->id]) }}" method="POST" enctype="multipart/form-data">
                   ...
                   <input type="text" name="title" value="{{ $ad->title }}" class="form-control" placeholder="Title"><br>
                   <label for="body">Ad description:</label>
                   <textarea name="body" cols="30" rows="10" placeholder="Ad description" class="form-control">
                       {{ $ad->body }}
                  </textarea><br>
                   <label for="price">Price:</label>
                   <input type="number" name="price" value="{{ $ad->price }}" placeholder="Add price" class="form-control">
